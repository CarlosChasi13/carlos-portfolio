...
const experiences = [
  {
    ...
    period: "2024 - 2025",
    description:
      "Desarrollo de aplicaciones móviles con React Native, implementación de servicios backend con python. Creación de módulos personalizados sobre plataformas ERP, soporte técnico, pruebas funcionales y aseguramiento de la calidad en aplicaciones web y móviles. Obtención de datos de equipos especializados para registro y asaistencia.",
  },
  {
    ...
    period: "2023-2024",
    description:
      "Pruebas, mantenimiento y desarrollo del sitio web del departamente de Mentorías en Prowess usando React, Javascript y CSsS",
  },
  {
